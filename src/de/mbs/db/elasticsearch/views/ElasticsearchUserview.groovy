...
public class ElasticsearchUserview extends UserView {
	...
	public String add(User data) {
		...
		// Stelle ï¿½berarbeitet werden
		jsonUser.put("sessionID", data.getSessionId());
		// FIXME prï¿½fen ob IDs gï¿½ltig sind -> erst mï¿½glich wenn Portlet und
		// Group Views laufen
	...
	// Achtung diese suche ist fÃ¼r das Frontend gedacht
	@Override
