...
public class UserviewTest {
	...
	public void test2AddUser() {
		try {
			...
			System.err.println("Fehler im add User: " + ex.getMessage());
			ex.printStackTrace();
		}
	...
	public void test3EditUserName() {
		try {
			...
			// for(User
			// u:userView.getAll()){System.out.println(u.getUsername());}
		} catch (Exception ex) {
			System.err.println("Fehler im edit User: " + ex.getMessage());
			ex.printStackTrace();
		}
	}
	...
	public void test4Login() {
		try {
			...
			System.err.println("Fehler im login User: " + ex.getMessage());
			ex.printStackTrace();
		}
